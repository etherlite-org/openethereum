...
/// Create a new EtherLite chain spec.
pub fn new_etherlite<'a, T: Into<SpecParams<'a>>>(params: T) -> Spec {
    load(
        params.into(),
        include_bytes!("../../res/chainspec/etherlite.json"),
    )
}

/// Create a new EtherLiteTestnet chain spec.
pub fn new_etherlite_testnet<'a, T: Into<SpecParams<'a>>>(params: T) -> Spec {
    load(
        params.into(),
        include_bytes!("../../res/chainspec/etherlitetestnet.json"),
    )
}
